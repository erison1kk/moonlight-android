...
public class PreferenceConfiguration {
    ...
    private static final String SEPARATE_OSC_PREF_STRING = "checkbox_separate_osc";
    private static final String OSC_PLAYER_ASSIGNMENT_PREF_STRING = "list_osc_player_assignment";
    ...
    private static final boolean DEFAULT_SEPARATE_OSC = true;
    private static final String DEFAULT_OSC_PLAYER_ASSIGNMENT = "auto";
    ...
    public boolean separateOscController;
    public String oscPlayerAssignment;
    ...
    public static PreferenceConfiguration readPreferences(Context context) {
        ...
        config.separateOscController = prefs.getBoolean(SEPARATE_OSC_PREF_STRING, DEFAULT_SEPARATE_OSC);
        config.oscPlayerAssignment = prefs.getString(OSC_PLAYER_ASSIGNMENT_PREF_STRING, DEFAULT_OSC_PLAYER_ASSIGNMENT);
